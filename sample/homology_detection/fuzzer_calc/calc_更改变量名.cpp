...
long long power(long long IIIlllll,long long lllIllll)
{
	int  IllIllll=1;
...
long long cal(char *IIlIllll,int llIIllll,int IlIIllll,long long lIIIllll)
{
	int IIIIllll=0;
    int llllIlll[N];
    int IlllIlll=M;
	...
	if(IIIIllll)
	{
		...
		return power(cal(IIlIllll,llIIllll,lIllIlll-1,lIIIllll),cal(IIlIllll,lIllIlll+1,IlIIllll,lIIIllll));
		if(IIlIllll[lIllIlll]=='*')
		return (cal(IIlIllll,llIIllll,lIllIlll-1,lIIIllll)*cal(IIlIllll,lIllIlll+1,IlIIllll,lIIIllll))%M;
		if(IIlIllll[lIllIlll]=='+')
		return (cal(IIlIllll,llIIllll,lIllIlll-1,lIIIllll)+cal(IIlIllll,lIllIlll+1,IlIIllll,lIIIllll))%M;
		if(IIlIllll[lIllIlll]=='-')
		return (cal(IIlIllll,llIIllll,lIllIlll-1,lIIIllll)-cal(IIlIllll,lIllIlll+1,IlIIllll,lIIIllll))%M;
...
int main()
{
	...
	lIIIllll[lIlIllll]=cal(IIlIIlll[0],0,lllIIlll-1,lIlIllll-5);
	for(lIlIllll=1; lIlIllll<=lllIllll; lIlIllll++)
	{
		IlIlIlll=1;
		for(lIIlIlll=0; lIIlIlll<=10; lIIlIlll++)
		if(lIIIllll[lIIlIlll]!=cal(IIlIIlll[lIlIllll],0,IllIIlll[lIlIllll]-1,lIIlIlll-5))
		{
			IlIlIlll=0;
			break;
		}
