...
long long power(long long lIlIIlll,long long IIIlllll)
;

long long cal(char *IlllIlll,int lIllIlll,int IIllIlll,long long llllIlll)
;
...
int main()
{
	...
	llllIlll[lllIllll]=cal(IIIIllll[0],0,IIlIllll-1,lllIllll-5);
	for(lllIllll=1; lllIllll<=IIIlllll; lllIllll++)
	{
		lIIIllll=1;
		for(IllIllll=0; IllIllll<=10; IllIllll++)
		if(llllIlll[IllIllll]!=cal(IIIIllll[lllIllll],0,llIIllll[lllIllll]-1,IllIllll-5))
		{
			lIIIllll=0;
			break;
		}
...
long long cal(char *IlllIlll,int lIllIlll,int IIllIlll,long long llllIlll)
{
	...
	if(llIlIlll)
	{
		...
		return power(cal(IlllIlll,lIllIlll,IIIlIlll-1,llllIlll),cal(IlllIlll,IIIlIlll+1,IIllIlll,llllIlll));
		if(IlllIlll[IIIlIlll]=='*')
		return (cal(IlllIlll,lIllIlll,IIIlIlll-1,llllIlll)*cal(IlllIlll,IIIlIlll+1,IIllIlll,llllIlll))%M;
		if(IlllIlll[IIIlIlll]=='+')
		return (cal(IlllIlll,lIllIlll,IIIlIlll-1,llllIlll)+cal(IlllIlll,IIIlIlll+1,IIllIlll,llllIlll))%M;
		if(IlllIlll[IIIlIlll]=='-')
		return (cal(IlllIlll,lIllIlll,IIIlIlll-1,llllIlll)-cal(IlllIlll,IIIlIlll+1,IIllIlll,llllIlll))%M;
